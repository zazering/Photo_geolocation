# app/utils/geo_utils.py - Географические утилиты
geo_utils_content = '''import math
import re
...
with open("photo_geolocation/app/utils/geo_utils.py", "w") as f:
    f.write(geo_utils_content)

print("✅ Географические утилиты созданы")
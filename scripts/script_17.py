...
with open("photo_geolocation/tests/integration/test_api.py", "w") as f:
...
with open("photo_geolocation/Makefile", "w") as f:
    f.write(makefile_content)

print("✅ Интеграционные тесты и Makefile созданы")
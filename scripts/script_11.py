...
geolocation_service_content = '''import time
import uuid
...
with open("photo_geolocation/app/services/geolocation_service.py", "w") as f:
    f.write(geolocation_service_content)

print("✅ Основной сервис геолокации создан")